/*
 ...
 Source Schema         : dev_carols

 Target Server Type    : MySQL
 Target Server Version : 100113
 File Encoding         : 65001

 Date: 16/11/2017 22:09:07
*/
...
CREATE TABLE `order`  (
  ...
  `pick_up` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  ...
  `condition` enum('drop','tunggu','jemput','inap','drop-jemput') CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
CREATE TABLE `vehicle_types`  (
  ...
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `upsated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
...
CREATE TABLE `vehicles`  (
  ...
  `license_plate` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
